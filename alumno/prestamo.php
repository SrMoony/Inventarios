...
$sql = "select p.idPrestamo as id, p.idHerramienta as idh , al.numControl, concat(al.nombres, ' ', al.apellidos) as empleado, c.carrera as area ,h.herramienta, p.cantidad , DATE_FORMAT(p.fecha, '%d-%m-%Y') as fecha, concat(u.nombre, ' ', u.apellido) as prestamista  
from prestamos p 
...
<body>
    <header class="header">
        <a type="button" class="btn btn-warning" href="../alumno/alumnos.php">Resgistrar un nuevo empleado</a>

    </header>

    <body>
        <h3>empleados con prestamos activos</h3>
        <div class="col-md-12">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th class="text-center"><?php echo $row['empleado'] ?></th>
                            <th class="text-center"><?php echo $row['area'] ?></th>
